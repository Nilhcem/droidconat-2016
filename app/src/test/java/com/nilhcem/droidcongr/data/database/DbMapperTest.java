...
public class DbMapperTest {
    ...
    public void should_convert_db_sessions_to_app_sessions() {
        ...
        com.nilhcem.droidcongr.data.database.model.Session session = new com.nilhcem.droidcongr.data.database.model.Session(2, "now", 10, 3, "[1]", "title", "description");
        List<com.nilhcem.droidcongr.data.database.model.Session> sessions = singletonList(session);
    ...
    public void should_convert_app_session_to_db_session() {
        ...
        // When
        com.nilhcem.droidcongr.data.database.model.Session result = dbMapper.fromAppSession(session);
    ...
    public void should_convert_app_speaker_to_db_speaker() {
        ...
        // When
        com.nilhcem.droidcongr.data.database.model.Speaker result = dbMapper.fromAppSpeaker(speaker);
    ...
    public void should_convert_db_speakers_to_app_speakers() {
        // Given
        com.nilhcem.droidcongr.data.database.model.Speaker speaker = new com.nilhcem.droidcongr.data.database.model.Speaker(58, "nilh", "dev", "bio", "nilhcem.com", "Nilhcem", "nilhcem", "photo");
