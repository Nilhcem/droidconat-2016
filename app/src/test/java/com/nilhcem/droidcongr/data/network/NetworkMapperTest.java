...
public class NetworkMapperTest {
    ...
    public void should_convert_network_speakers_to_app_speakers() {
        ...
        // When
        List<com.nilhcem.droidcongr.data.app.model.Speaker> result = networkMapper.toAppSpeakers(speakers);
    ...
    public void should_convert_network_sessions_to_app_sessions() {
        ...
        Map<Integer, com.nilhcem.droidcongr.data.app.model.Speaker> speakersMap = new HashMap<>();
        speakersMap.put(10, new com.nilhcem.droidcongr.data.app.model.Speaker(10, "ten", null, null, null, null, null, null));

        // When
        List<com.nilhcem.droidcongr.data.app.model.Session> result = networkMapper.toAppSessions(singletonList(session), speakersMap);
