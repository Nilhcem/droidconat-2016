package com.nilhcem.droidcongr.data.database.dao;

import android.database.Cursor;

import com.nilhcem.droidcongr.core.moshi.LocalDateTimeAdapter;
import com.nilhcem.droidcongr.data.app.SelectedSessionsMemory;
import com.nilhcem.droidcongr.data.database.DbMapper;
import com.nilhcem.droidcongr.data.database.model.SelectedSession;
import com.nilhcem.droidcongr.data.database.model.Session;
import com.nilhcem.droidcongr.utils.Preconditions;
...
public class SessionsDao {
    ...
    public Observable<List<com.nilhcem.droidcongr.data.app.model.Session>> getSessions() {
        return getSessions("SELECT * FROM " + Session.TABLE);
    }

    public Observable<List<com.nilhcem.droidcongr.data.app.model.Session>> getSelectedSessions() {
    ...
    public Observable<List<com.nilhcem.droidcongr.data.app.model.Session>> getSelectedSessions(LocalDateTime slotTime) {
    ...
    public void toggleSelectedSessionState(com.nilhcem.droidcongr.data.app.model.Session session, boolean insert) {
    ...
    public void saveSessions(List<com.nilhcem.droidcongr.data.app.model.Session> toSave) {
        Preconditions.checkNotOnMainThread();

        BriteDatabase.Transaction transaction = database.newTransaction();
        try {
            database.delete(Session.TABLE, null);
            for (com.nilhcem.droidcongr.data.app.model.Session session : toSave) {
    ...
    public Observable<Boolean> isSelected(com.nilhcem.droidcongr.data.app.model.Session session) {
    ...
    private Observable<List<com.nilhcem.droidcongr.data.app.model.Session>> getSessions(String query, String... args) {
