package com.nilhcem.droidcongr.data.database;

import android.support.annotation.NonNull;
import android.support.annotation.Nullable;

import com.nilhcem.droidcongr.core.moshi.LocalDateTimeAdapter;
import com.nilhcem.droidcongr.data.app.AppMapper;
import com.nilhcem.droidcongr.data.app.model.Room;
import com.nilhcem.droidcongr.data.database.model.Session;
import com.nilhcem.droidcongr.data.database.model.Speaker;
...
public class DbMapper {
    ...
    public List<com.nilhcem.droidcongr.data.app.model.Session> toAppSessions(@NonNull List<Session> from, @NonNull Map<Integer, com.nilhcem.droidcongr.data.app.model.Speaker> speakersMap) {
        return stream(from).map(session -> {
            LocalDateTime fromTime = localDateTimeAdapter.fromText(session.startAt);
            return new com.nilhcem.droidcongr.data.app.model.Session(session.id, Room.getFromId(session.roomId).label,
    ...
    public Session fromAppSession(@Nullable com.nilhcem.droidcongr.data.app.model.Session from) {
        if (from == null) {
            return null;
        }
    ...
    public Speaker fromAppSpeaker(@Nullable com.nilhcem.droidcongr.data.app.model.Speaker from) {
        if (from == null) {
            return null;
        }
    ...
    public List<com.nilhcem.droidcongr.data.app.model.Speaker> toAppSpeakers(@Nullable List<Speaker> from) {
        if (from == null) {
            return null;
        }

        return stream(from).map(speaker -> new com.nilhcem.droidcongr.data.app.model.Speaker(speaker.id,
